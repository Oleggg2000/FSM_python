class FSM:
    ...
    Маркером конца цепочки принять за сивол "|"

    Если нету перехода из данного состояния в другое, то оставить место пустым пробелом.
    ...
    По умолчанию каждое состояние инициализируется [['error'], ['error'], ['error']]
    """
